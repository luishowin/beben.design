...
Beben Design is a design-led digital product studio based in Westlands,
Nairobi, Kenya. The studio's philosophy: design logic before the first line
of code. Every engagement starts with understanding user behaviour through
...
- Also: mobile UI, desktop app UI, human-machine interfaces (HMI) for
  hardware products, AI integration, rebranding, posters and print.

## How engagements work

1. You reach out with the problem, not the solution.
2. A 30-minute discovery call covers goals, constraints, and timelines.
3. A fixed-price, line-item proposal follows within 48 hours. No hourly
